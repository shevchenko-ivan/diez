...
export const TOPICS: Topic[] = [
  ...
  },
  {
    ...
    seoIntro:
      "Пісні біля вогнища — це особливий формат: проста гармонія, впізнаваний мотив і слова, які знає більшість людей у компанії. Тут не потрібен віртуоз — потрібен той, хто впевнено тримає чотири акорди й веде ритм. У цій підбірці зібрані пісні, які десятиліттями звучать на українських посиденьках: «Червона рута», «Несе Галя воду», «Ніч яка місячна», «Червона калина», «Обійми», «Човен», «Два кольори». Поряд із народною класикою — естрадні хіти Океану Ельзи, Скрябіна, Бумбоксу й Одного в каное. Усі акорди адаптовані під зручну тональність для співу — навіть якщо у вас обмежений діапазон, ви знайдете варіант, який ляже на голос. Натисніть на пісню, і вона відкриється з акордами над кожним рядком тексту, із можливістю транспонувати тональність і змінювати позицію капо.",
    match: {
      kind: "slugs",
      slugs: [
        "chervona-ruta",
