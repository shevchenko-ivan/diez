...
export const metadata: Metadata = {
  ...
  description:
    "Як подати скаргу правовласника. Процедура повідомлення про порушення, обов'язкові поля, термін відповіді та політика щодо повторних порушників.",
        ...
        >
          ...
          <section>
            ...
            <ol className="space-y-2 list-decimal pl-5">
              ...
              <li>
                <strong>Підпис</strong> — електронний (повне ім'я) або фізичний (скан).
              </li>
            </ol>
            <p className="mt-3">
